...
import { Mail, Phone, FileText, ArrowLeft, Users } from 'lucide-react'
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">Configure uma campanha para converter clientes CPF em CNPJ</p>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                {selectedClients.length} cliente{selectedClients.length !== 1 ? 's' : ''} selecionado{selectedClients.length !== 1 ? 's' : ''} para esta campanha
              </p>
            </div>
          </div>
        ...
        <Card className="p-6">
          ...
          <div className="mt-6 flex items-center justify-end space-x-4" data-tour-id="campaign-form-actions">
            ...
            <Button
              type="submit"
              variant="primary"
              disabled={loading || !campaignType || !campaignName || selectedClients.length === 0}
            >
